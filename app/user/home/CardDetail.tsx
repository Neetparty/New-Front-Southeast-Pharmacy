...
export default function CardDetail({t, item, handleLang}:{
    ...
    <div className="w-full h-full">
        <div className="h-full max-h-[26rem] w-full border rounded-lg hover:shadow-md mb-8 flex flex-col justify-between gap-2  text-start  overflow-hidden">
