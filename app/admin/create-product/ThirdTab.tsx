...
export default function ThirdTab() {
    ...
    const {state, setState}:CreateProductContext = useCreateProduct?.()!;
    ...
    <div  className="flex flex-col gap-8">
            ...
            <div className="flex gap-2 flex-col">
                ...
                value={state.desc_ch}
                onChange={(event: React.ChangeEvent<HTMLTextAreaElement>) => setState(prev => ({...prev, desc_ch:event.target.value}))}
            ...
            <div className="flex gap-2 flex-col">
                ...
                <Input
                value={state.warning_cn}
                onChange={(e:React.ChangeEvent<HTMLInputElement>) => setState(prev => ({...prev, warning_cn:e.target.value}))}
        ...
        <div className="flex justify-end">
            ...
            disabled={!state.product_cn || state.submit}
            >
            <h6 className="font-semibold">สร้างสินค้า</h6>
            </button>
        </div>
    </div>
);
