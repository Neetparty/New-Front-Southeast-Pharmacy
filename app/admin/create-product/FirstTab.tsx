...
export default function FirstTab() {
    ...
    const {handleRemoveSubImage, handleImageChange, handleRemoveImage, setState, state, thHandler, handleSubImageChange}:CreateProductContext = useCreateProduct?.()!;
    ...
    <>
            ...
            <div className="flex gap-2 flex-col">
                ...
                <div className="flex gap-2">
                    <div className="flex items-center mb-4">
                        ...
                        type="radio" 
                        value={"ไม่ใช่"}
                        checked={state.isSpecial ? false : true}
                        onChange={(e: React.ChangeEvent<HTMLInputElement>) => setState(prev => ({...prev, isSpecial:!prev.isSpecial}))} 
                        className="w-4 h-4"
                        />
                        <label 
                        htmlFor="promotion-1" 
                    ...
                    <div className="flex items-center mb-4">
                        ...
                        type="radio" 
                        value={"ใช่"}
                        checked={state.isSpecial ? true : false}
                        onChange={(e: React.ChangeEvent<HTMLInputElement>) => setState(prev => ({...prev, isSpecial:!prev.isSpecial}))} 
                        className="w-4 h-4"
                        />
                        <label 
        ...
        <div className="flex justify-end">
            ...
            disabled={!state.product_th || state.price === 0 || state.quantity === 0 || state.weight === 0 || !state.cateId || !state.desc}
            >
